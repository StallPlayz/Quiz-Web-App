  ...
  <div class="container">
    ...
    <form method="POST">
      ...
      <div class="password-wrapper" style="position: relative; width: 100%;">
        <input type="password" id="password" name="password" placeholder="Enter your password" style="width: calc(100% - 50px); padding-right: 50px;" />
    ...
    <p style="text-align:center; margin-top: 10px;">
      ...
      <a href="register.php" style="color: #ffddff;">Register here</a>
    </p>
  </div>
